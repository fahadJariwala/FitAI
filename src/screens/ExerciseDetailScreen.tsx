  ...
  const trackExercise = async () => {
    ...
    if (timer === 0) {
      showAlert({
        type: 'info',
        title: 'Warning',
        message: 'Please track some time before completing',
        buttons: [
          {
            text: 'OK',
            style: 'default',
    ...
    try {
      ...
      showAlert({
        ...
        message: `Exercise tracked for ${formatTime(timer)} minutes!`,
        buttons: [
          {
            text: 'OK',
            style: 'default',
      ...
      showAlert({
        type: 'error',
        title: 'Error tracking exercise',
        message: 'Failed to track exercise. Please try again.',
        buttons: [
          {
            text: 'OK',
            style: 'default',
