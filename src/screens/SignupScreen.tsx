      ...
      try {
        ...
        if (error.message?.includes('profile') && authData?.user?.id) {
          try {
            ...
            console.error(
              'Failed to cleanup user after profile creation error:',
              cleanupError,
            );
          }
        }
    ...
    <KeyboardAvoidingView
      ...
      <ScrollView
        ...
        <Text style={styles.subtitle}>
          Join FitAI to start your fitness journey
        </Text>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.loginLinkText}>
            Don't have an account? <Text style={styles.loginText}>Login</Text>
          </Text>
        </TouchableOpacity>
